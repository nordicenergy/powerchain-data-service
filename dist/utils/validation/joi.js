...
module.exports = rawJoi
    ...
    language: {
        ...
        assetId: 'must be a valid base58 string or "POWERCHAIN"',
    ...
    rules: [
        ...
        ]),
        {
            ...
            validate(_, value, state, options) {
                ...
                return Maybe.of(value)
                    ...
                    .filter(([prefix, val]) => prefix === 'base64' &&
                    !joi
                        .string()
        ...
        },
        {
            ...
            validate(params, value, state, options) {
                ...
                return i.matchWith({
                    ...
                    Error: ({ value: e }) => this.createError('string.period.accept', { value, e }, state, options),
                });
            },
        },
        {
            ...
            validate(params, value, state, options) {
                ...
                return i.matchWith({
                    Ok: ({ value: i }) => divisibleByInterval.matchWith({
                        Ok: ({ value: d }) => {
                            if (div(i, d) % 1 !== 0) {
                        ...
                        Error: ({ value: e }) => this.createError('string.period.divisibleBy', { value, e }, state, options),
                    }),
                    Error: ({ value: e }) => this.createError('string.period.interval', { value, e }, state, options),
                });
            },
        },
        {
            ...
            validate(params, value, state, options) {
                ...
                return i.matchWith({
                    Ok: ({ value: i }) => minInterval.matchWith({
                        Ok: ({ value: d }) => {
                        ...
                        Error: ({ value: e }) => this.createError('string.period.minInterval', { value, e }, state, options),
                    }),
                    Error: ({ value: e }) => this.createError('string.period.interval', { value, e }, state, options),
                });
            },
        },
        {
            ...
            validate(params, value, state, options) {
                ...
                return i.matchWith({
                    Ok: ({ value: i }) => maxInterval.matchWith({
                        Ok: ({ value: d }) => {
                            if (d.length < i.length) {
                        ...
                        Error: ({ value: e }) => this.createError('string.period.maxInterval', { value, e }, state, options),
                    }),
                    Error: ({ value: e }) => this.createError('string.period.interval', { value, e }, state, options),
                });
            },
        ...
        },
        {
            ...
            validate(_, value, state, options) {
                ...
                if (!(value instanceof BigNumber) ||
                    ...
                    return this.createError('object.bignumber.int64', { value: value.toString() }, state, options);
                }
                return value;
            },
        },
